...
```bash
aws ssm put-parameter --name "/service/pipeline/github/repo" --description "Github Repository name for Cloudformation Stack pipeline-pipeline" --type "String" --value "crafting-serverless"

aws ssm put-parameter --name "/service/pipeline/github/token" --description "Github Token for Cloudformation Stack pipeline-pipeline" --type "String" --value "ecdb12345bb7d4746c87ffd07f3f3179b3622c7a"

aws ssm put-parameter --name "/service/pipeline/github/user" --description "Github Username for Cloudformation Stack pipeline-pipeline" --type "String" --value "coulas"
```
